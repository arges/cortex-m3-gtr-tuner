/*
 ...
 Fs (sampling frequency) = 4410 Hz
 N = 512


Want to hit these frequencies:
 82 Hz, 110 Hz, 147 Hz, 196 Hz, 247 Hz, 330 Hz

 */

/* Based on code from: www.jjj.de/crs4/integer_fft.c 
   Written by:  Tom Roberts  11/8/89
   Made portable:  Malcolm Slaney 12/15/94 malcolm@interval.com

   Also basic algorithm based off the paper: ...
*/
...
static inline fixed fix_mpy(fixed a, fixed b);
...
*/
inline static fixed fix_mpy(fixed a, fixed b)
{
        FIX_MPY(a,a,b);
        return a;
}
...
void do_fft(short int *input, short int *output) {
        int i;
        fixed real[N], imag[N];
